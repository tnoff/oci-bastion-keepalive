...
- chore(deps): update https://github.com/tnoff/github-workflows digest to 8f11289

## [0.2.22] - 2026-09-14

### Changed

- chore(deps): update https://github.com/tnoff/github-workflows digest to 0d92c3c
...
- fix(deps): pin kubernetes to 36.0.0 to resolve the oci-cli PyYAML conflict that broke `pip install`
...
- chore(deps): update https://gitlab.com/tnoff-projects/github-workflows digest to 618e175
